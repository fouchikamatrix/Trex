...
try {
    ...
    $pending_bills = [];
    error_log("Gas payment bills error: " . $e->getMessage());
}
...
<div class="payment-container">
    <div class="payment-header">
        ...
        <h1>Gas Payment</h1>
        <p>Pay your gas bills securely online</p>
    </div>
...
if (!empty($pending_bills)) {
    ...
    $content .= '
        <div class="no-bills">
            ...
            <p>You don\'t have any pending gas bills to pay at the moment.</p>
