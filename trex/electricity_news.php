...
<div class="news-container">
    <div class="news-header">
        ...
        <h1>Electricity Service News</h1>
        <p>Stay updated with the latest electricity service announcements and updates</p>
    </div>
...
if (!empty($news)) {
    ...
    <div class="no-news">
        ...
        <p>There are currently no electricity service news or announcements. Check back later for updates.</p>
    </div>';
}
