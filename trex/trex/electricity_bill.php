...
function showBillDetails(billId) {
    ...
    modalBody.innerHTML = `
        <div style="text-align: center; padding: 40px;">
            <i class="fas fa-spinner fa-spin" style="font-size: 2rem; color: #4dabf7;"></i>
    ...
    modalBody.innerHTML = `
        ...
        <div class="modal-section">
            ...
            <div class="modal-grid">
                ...
                <div class="modal-item" style="background: rgba(77, 171, 247, 0.2); border-color: rgba(77, 171, 247, 0.4);">
                    <div class="modal-item-label">Total à payer</div>
                    <div class="modal-item-value" style="font-size: 1.2rem; color: #4dabf7;">${bill.amount} $</div>
                </div>
            </div>
        </div>
